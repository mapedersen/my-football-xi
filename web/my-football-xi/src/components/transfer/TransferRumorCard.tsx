...
import { saveFanOpinion, getFanOpinionForRumor } from '@/services/transferService';

interface TransferRumorCardProps {
  rumor: TransferRumor;
}

const TransferRumorCard: React.FC<TransferRumorCardProps> = ({ rumor }) => {
  const existingOpinion = getFanOpinionForRumor(rumor.id);
