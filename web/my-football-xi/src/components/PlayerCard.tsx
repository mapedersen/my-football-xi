...
import { Player, PlayerTag } from "../models/Player";
      ...
      <div className="p-2 bg-white rounded-b-lg border-t border-gray-200">
        ...
        {status && (
          <div className="mt-1 flex flex-wrap gap-1">
            {status.captain && (
              <span className="status-badge status-badge-captain">Captain</span>
            )}
            {status.injured && (
              <span className="status-badge status-badge-injured">Injured</span>
            )}
            {status.onLoan && (
              <span className="status-badge status-badge-loan">On Loan</span>
            )}
          </div>
        )}
